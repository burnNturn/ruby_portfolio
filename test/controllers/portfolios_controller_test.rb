...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should update portfolio" do
    patch :update, id: @portfolio, portfolio: { cash_balance: @portfolio.cash_balance, equities_value: @portfolio.equities_value, name: @portfolio.name, total_value: @portfolio.total_value }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
